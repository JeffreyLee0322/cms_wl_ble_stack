 ...
 *           for the CMSARM CMS32F030x Series
 * @version  V2.10
...
#ifndef __CMS32F030X_H__
#define __CMS32F030X_H__
...
/*@}*/ /* end of group CMS32F030x_CMSIS */


#include <core_cm0.h>                       /* Cortex-M0 processor and core peripherals           */
#include "system_CMS32F030x.h"                   /* CMS32F030x System  include file                         */


/******************************************************************************/
/*                Device Specific Peripheral registers structures             */
/******************************************************************************/
/** @addtogroup CMS32F030x_Peripherals CMS32F030x Peripherals
  CMS32F030x Device Specific Peripheral registers structures
  @{
*/
...
/** @addtogroup CMS32F030x_GPIO General Purpose Input/Output (GPIO)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_GPIO */

/*------------- Capture/PWM (PWM) Controller ---------------------------------*/
/** @addtogroup CMS32F030x_PWM Capture/PWM (PWM)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_PWM */



/*------------- EPWM ( Controller ---------------------------------*/
/** @addtogroup CMS32F030x_EPWM
  @{
*/
typedef struct
{
...
/** @addtogroup CMS32F030x_ADC CMS32F030x Analog-to-Digital Converter (ADC)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_ADC */

/*------------- Universal Asynchronous Receiver Transmitter (UART) -----------*/
/** @addtogroup CMS32F030x_UART CMS32F030x Universal Asynchronous Receiver Transmitter (UART)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_UART */

/*------------- Timer (TMR) --------------------------------------------------*/
/** @addtogroup CMS32F030x_TMR CMS32F030x 32/16-bit Timer (TMR)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_TMR */


/*------------- WWDT --------------------------------------------------*/
/** @addtogroup CMS32F030x_TMR CMS32F030x 32/16-bit WWDT
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_WWDT */


/*------------- Watchdog Timer (WDT) -----------------------------------------*/
/** @addtogroup CMS32F030x_WDT CMS32F030x 32-bit Watchdog Timer (WDT)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_WDT */

/*------------- Inter-Integrated Circuit (I2C) -------------------------------*/
/** @addtogroup CMS32F030x_I2C CMS32F030x Inter-Integrated Circuit (I2C)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_I2C */

/*------------- Synchronous Serial Communication (SSP) -----------------------*/
/** @addtogroup CMS32F030x_SSP Synchronous Serial Communication (SSP)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_SSP */

/*------------- System Control (SYSCON) --------------------------------------*/
/** @addtogroup CMS32F030x_SYSCON CMS32F030x System Control (SYSCON)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_SYSCON */

/*------------- Flash Memory Controller (FMC) --------------------------------*/
/** @addtogroup CMS32F030x_FMC CMS32F030x Flash Memory Controller (FMC)
  @{
*/
typedef struct
{
...
/*@}*/ /* end of group CMS32F030x_Peripherals */


/******************************************************************************/
/*                         Peripheral memory map                              */
/******************************************************************************/
/** @addtogroup CMS32F030x_MemoryMap CMS32F030x Memory Mapping
  @{
*/
...
/*@}*/ /* end of group CMS32F030x_MemoryMap */

/******************************************************************************/
/*                         Peripheral declaration                             */
/******************************************************************************/
/** @addtogroup CMS32F030x_PeripheralDecl CMS32F030x Peripheral Declaration
  @{
*/
...
/*@}*/ /* end of group CMS32F030x_PeripheralDecl */


/*@}*/ /* end of group CMS32F030x_Definitions */
